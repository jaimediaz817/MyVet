...
namespace MyVet.DAL.Migrations
{
    ...
    [Migration("20190924040752_Users")]
    partial class Users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVet.DAL.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyVet.DAL.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyVet.DAL.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("MyVet.DAL.Data.Entities.Manager", b =>
                {
                    b.HasOne("MyVet.DAL.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("MyVet.Web.Data.Entities.Agenda", b =>
                {
                    b.HasOne("MyVet.DAL.Data.Entities.Owner", "Owner")
                        .WithMany("Agendas")
